...
@app.route('/')
def home():
    return "KESHVEXFF NON STOP HOSTING BOT"
...
YOUR_USERNAME = os.getenv('YOUR_USERNAME', '@vkboyx77')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', '@VK_FF_SHADOW')

# Limits from .env or defaults
FREE_USER_LIMIT = int(os.getenv('FREE_USER_LIMIT', 9999))
SUBSCRIBED_USER_LIMIT = int(os.getenv('SUBSCRIBED_USER_LIMIT', 9999))
